...
function insertSampleData() {
    ...
    samplePatients.forEach((patient, index) => {
        insertPatient.run([
            ...
            if (err) {
                ...
                console.log(`✓ Inserted patient: ${patient.first_name} ${patient.last_name} (${patient.disease_diagnosis})`);
            }
        });
    });
    ...
    console.log('• 20 patients with various diseases and locations');
    console.log('• 5 sample medical reports');
    console.log('• Disease distribution across multiple states');
    console.log('• Geographic spread for meaningful analytics');
    console.log('\nYou can now view the populated dashboard at http://localhost:3000');
